...
ROOT_URLCONF = "brp_amsterdam_api.urls"
...
WSGI_APPLICATION = "brp_amsterdam_api.wsgi.application"
...
if CLOUD_ENV.startswith("azure"):
    ...
    if AZURE_APPI_CONNECTION_STRING is not None:
        configure_azure_monitor(
            ...
            resource=Resource.create({ResourceAttributes.SERVICE_NAME: "brp-amsterdam-api"}),
        )
