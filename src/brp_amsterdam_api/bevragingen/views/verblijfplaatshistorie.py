...
BASE_FIELD_NAMES = fields.read_config("rvig_brp_api/verblijfplaatshistorie/fields.csv")
ADRES_FIELD_NAMES = fields.read_config("rvig_brp_api/verblijfplaatshistorie/fields-Adres.csv")
LOCATIE_FIELD_NAMES = fields.read_config("rvig_brp_api/verblijfplaatshistorie/fields-Locatie.csv")
VERBLIJFPLAATSBUITENLAND_FIELD_NAMES = fields.read_config(
    "rvig_brp_api/verblijfplaatshistorie/fields-VerblijfplaatsBuitenland.csv"
)
VERBLIJFPLAATSONBEKEND_FIELD_NAMES = fields.read_config(
    "rvig_brp_api/verblijfplaatshistorie/fields-VerblijfplaatsOnbekend.csv"
)
